...
class [[eosio::contract("authstable_old")]] authstable_old : public eosio::contract {
    ...
    authstable_old(name receiver, name code, datastream<const char*> ds):contract(receiver, code, ds) {}
    ...
    [[eosio::action]]
    void upsert( string owner, string perm, string account, string accperm, string attributes) {
    ...
    private:
        ...
        using address_index = eosio::multi_index<"authstable_old"_n, authority>;
        /* With the above multi_index configuration there is a table named authstable_old, that
